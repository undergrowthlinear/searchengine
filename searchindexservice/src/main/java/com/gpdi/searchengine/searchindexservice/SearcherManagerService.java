...
import com.gpdi.searchengine.searchindexservice.search.SearchResult;
...
public class SearcherManagerService {
	...
	public SearchResult search(String fieldName, String searchValue, int num) {
		return search(fieldName, searchValue, num, null);
	}

	public SearchResult search(Query query, int num) {
		return search(query, num, null);
	}
	...
	public SearchResult search(Query query, int num, Sort sort, Filter filter) {
		...
		try {
			...
			logger.info("query:" + query.toString() + "," + "num:" + num + ","
					+ "filter:" + filter.toString() + "," + "sort:"
					+ sort.toString());
	...
	public SearchResult searchPageAfter(String indexPath, Query query,
